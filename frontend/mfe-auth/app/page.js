            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    {loading ? (
                        ...
                        <div className="mt-8">
                            <p className="mb-4">Join our community to get started!</p>
                            <div className="space-x-4">
                                <a
                                    href="/auth/login"
                                    className="inline-block bg-gray-100 text-gray-800 px-5 py-3 rounded-md font-medium hover:bg-gray-200"
                                >
                                    Sign In
                                </a>
                                <a
                                    href="/auth/register"
                                    className="inline-block bg-blue-600 text-white px-5 py-3 rounded-md font-medium hover:bg-blue-700"
                                >
                                    Sign Up
                                </a>
                            </div>
